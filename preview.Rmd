...
```
## Limpieza de datos
NOTA: Nos lo da skim, pero queria ver como se hacia  
vemos cuantos valores faltantes tengo por columna. 
```{r}
faltantes_por_columna <- colSums(is.na(st))
...
#aqui viene lo de hacer dummies y separalos los valores que sean necesarios. 
