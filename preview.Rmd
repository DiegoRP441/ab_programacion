...
Tras realizar varias pruebas con un par de modelos hemos concluido que el mejor modelo es Naive Bayes ya que nos da una `accuracy` del 0.8 bastante superior a la obtenido con la regresión lineal de 0.6
